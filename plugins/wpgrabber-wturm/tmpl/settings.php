...
<div id="icon-options-general" class="icon32"></div><h2>WPGrabber - Настройки -
    <a href="https://kwork.ru/script-programming/74574/grabber-dlya-wordpress-nastroyka-parsinga-s-lyubykh-saytov?ref=6517" target="_blank" title="Заказать платную настройку лент"><b>Заказать настройку лент</b></a> </h2>
...
<div class="tab-content" id="div_tab1"<?php echo $tab == 1 ? ' style="display: block;"' : ''; ?>>
    <fieldset>
        ...
        <tr>
            ...
            <td><?php echo WPGHelper::yesNoRadioList('options[curlHeaderOn]', get_option('wpg_' .'curlHeaderOn')); ?>&nbsp;&nbsp;&nbsp;&nbsp;<i>(CURL-опция: CURLOPT_HEADER)</i></td>
        </tr>
        <tr>
            <td>Включить <b>отправляемые заголовки</b> HTTP-запроса <br></td>
            <td><?php echo WPGHelper::yesNoRadioList('options[curlinfoHeaderOutOn]', get_option('wpg_' .'curlinfoHeaderOutOn')); ?>&nbsp;&nbsp;&nbsp;&nbsp;<i>(CURL-опция: CURLINFO_HEADER_OUT)</i></td>
        </tr>
        <tr>
        ...
        <tr>
            <td>Содержимое заголовка "User-Agent: ", посылаемого в HTTP-запросе</td>
            <td><input type="text" size="35" name="options[userAgent]" value="<?php echo get_option('wpg_' .'userAgent'); ?>" /> <i>("Mozilla/5.0 (Windows NT 5.1; rv:26.0) Gecko/20100101 Firefox/26.0" - по умолчанию)</i></td>
        </tr>
        <tr>
            <td>Включить <b>GZIP</b> сжатие <br></td>
            <td><?php echo WPGHelper::yesNoRadioList('options[curlGzipOn]', get_option('wpg_' .'curlGzipOn')); ?>&nbsp;&nbsp;&nbsp;&nbsp;<i>(CURLOPT_HTTPHEADER: Accept-Encoding: gzip, CURL-опция: CURLOPT_ENCODING , "gzip")</i></td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td><?php echo WPGHelper::yesNoRadioList('options[getContentWriteLogsOn]', get_option('wpg_' .'getContentWriteLogsOn')); ?>&nbsp;&nbsp;&nbsp;&nbsp;<i>($this-> tmpDir. md5($url).".html")</i></td>
        </tr>
        </table>
    </fieldset>
     <fieldset>
...
<div class="tab-content" id="div_tab4"<?php echo $tab == 4 ? ' style="display: block;"' : ''; ?>>
    <fieldset>
        ...
        <tr>
            ...
            <b>Внимание!</b> Для работы данного метода обновления Вам потребуется настроить CRON-задание на Вашем сервере (хостинге) <a href="http://wpgrabber-tune.blogspot.ru/2017/11/wpgrabber-cron.html" target="_blank">( подробнее )</a>
            </div>
            </td>
        </tr>
        <tr>
