  ...
  class WPGPlugin {
    ...
    protected static function _footer() {
      echo '<div style="text-align: left; padding-top: 20px; margin-top: 30px; font-size: 16px;">&copy 2013-'.date('Y').' WPGrabber '.
        WPGRABBER_VERSION.' - Служба Поддержки <a target="_blank" href="https://kwork.ru/script-programming/74574/grabber-dlya-wordpress-nastroyka-parsinga-s-lyubykh-saytov?ref=6517">WPGrabber</a>.</div>';
    }
