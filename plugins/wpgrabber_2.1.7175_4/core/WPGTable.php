...
class WPGTable extends WP_List_Table
{
    ...
    function prepare_items()
    {
        ...
        var_export($per_page_option);
        */

        // Получить количество элементов для отображения на одной странице
        $per_page = $this->get_items_per_page('wpgrabber_feeds_per_page', 256); # По умолчанию: 256
        #var_export($per_page);
